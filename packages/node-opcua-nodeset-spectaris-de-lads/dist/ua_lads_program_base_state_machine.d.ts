...
export interface UALADSProgramBaseStateMachine_clearedStateMachine extends Omit<UALADSProgramClearedStateMachine, "availableStates" | "availableTransitions" | "clearingToStopped" | "currentState" | "reset" | "running" | "runningStateMachine" | "runningToStopped" | "stop" | "stoppedToRunning" | "stoppingToStopped"> {
