...
export interface UALADSComponent_identification extends Omit<UAMachineryComponentIdentification, "deviceRevision" | "initialOperationDate" | "manufacturer" | "monthOfConstruction" | "serialNumber" | "yearOfConstruction"> {
    /**
     * deviceRevision
